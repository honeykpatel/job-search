...
JOB_AGENT_PROMPT = (
    ...
    "If required information is missing, ask a concise professional follow-up and present available choices clearly. "
    "Do not expose backend ids, row ids, thread ids, or numeric internal references to the user. "
...
GENERAL_AGENT_PROMPT = (
    ...
    "If the user asks to create a new Helper, use only the create_helper tool unless they explicitly ask to rename or delete an existing Helper. "
    ...
    "If any required detail is missing, ask a concise professional follow-up and present the available options clearly. "
    "Do not expose backend ids, row ids, thread ids, or numeric internal references to the user. "
